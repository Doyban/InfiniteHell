...
InfiniteHell.Menu.prototype = {
    preload: function() {
        ...
        // Buttons.
        // this.inviteButton = this.game.add.button(this.game.width/2 - this.difference, this.game.world.centerY + 150, "invite", this.inviteStart, this);
        // this.inviteButton.anchor.setTo(0.5);

        // this.adsButton = this.game.add.button(this.game.width/2, this.game.world.centerY + 150, 'ads', this.adsStart, this);
